...
function CategoryBranch({
  ...
  return (
    <li>
      <div
        className="group/item flex items-center rounded-xl transition-colors duration-150 hover:bg-slate-50"
      >
        ...
        {hasChildren && (
          <button
            ...
            className="ml-1 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600"
