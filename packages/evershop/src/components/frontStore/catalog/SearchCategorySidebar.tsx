  ...
  return (
    <li>
      <div className="group/item flex items-center">
        ...
        <a
          href={category.url}
          className="relative flex w-full items-center rounded-lg px-2 py-1.5 text-[13px] leading-snug text-slate-600 transition-all duration-150 hover:bg-orange-50 hover:text-orange-600"
        >
          {category.name}
        </a>
      </div>
