...
export function Footer({ copyRight }: FooterProps) {
  return (
    <footer className="footer mt-24 border-t-4 border-orange-500 bg-slate-900 pt-10 pb-6 text-white">
        ...
        coreComponents={[
          {
            component: {
              default: (
                <div className="page-width grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
                  <div>
                    <div className="card-icons flex justify-center space-x-3 md:justify-start opacity-60">
                      <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="38" height="24" viewBox="0 0 38 24" className="h-8">
                  ...
                  <div className="self-center">
                    <div className="copyright text-center md:text-right text-sm text-slate-400">
                      <span>{copyRight}</span>
                    </div>
                  </div>
                </div>
