...
function Actions({ orders = [], selectedIds = [] }) {
  ...
  const actions = [
    {
      name: 'Marquer comme expédié',
      onAction: () => {
        openAlert({
          heading: `Expédier ${selectedIds.length} commandes`,
          content: (
            <div className="form-field mb-0">
              Êtes-vous sûr de vouloir marquer les commandes sélectionnées comme expédiées ?
            </div>
          ),
          primaryAction: {
            title: 'Annuler',
                  ...
                  component: {
                    default: () => (
                      <>
                        ...
                        >
                          <SelectTrigger>
                            <SelectValue>Statut de paiement</SelectValue>
                          </SelectTrigger>
                          <SelectContent>
                            <SelectGroup>
                              <SelectLabel>Statut de paiement</SelectLabel>
                ...
                },
                {
                  component: {
                    default: () => (
                      ...
                      >
                        <SelectTrigger>
                          <SelectValue>Statut de livraison</SelectValue>
                        </SelectTrigger>
                        <SelectContent>
                          <SelectGroup>
                            <SelectLabel>Statut de livraison</SelectLabel>
